...
var JWTAuth = dsl.JWTSecurity("jwt", func() {
	...
	dsl.Scope("list-products", "list products")
	dsl.Scope("update-product", "update products")
	dsl.Scope("delete-product", "delete products")
	dsl.Scope("create-product", "create products")
