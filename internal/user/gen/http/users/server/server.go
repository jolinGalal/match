...
func New(
	...
	return &Server{
		Mounts: []*MountPoint{
			{"List", "GET", "/user/v1"},
			{"Create", "POST", "/user/v1"},
			{"Update", "PUT", "/user/v1/{id}"},
			{"Delete", "DELETE", "/user/v1/{id}"},
...
func MountDeleteHandler(mux goahttp.Muxer, h http.Handler) {
	...
	mux.Handle("DELETE", "/user/v1/{id}", f)
}
...
func MountLoginHandler(mux goahttp.Muxer, h http.Handler) {
	...
	mux.Handle("POST", "/user/v1/login", f)
}
