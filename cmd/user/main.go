...
import (
	...
	user_service "github.com/jolinGalal/match/internal/user/service/user"
...
func main() {
	...
	var (
		...
		hostPort    = flag.String("host_port", "8090", "Server host port (valid values: 8090)")
	...
	{
		usersSvc = user_service.NewUsers(logger, auth, dbgorm)
	}
